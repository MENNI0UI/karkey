    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-[#1e2a5e]">Manage Karkey Cars</h3>
                <Button onClick={() => {
                    setEditingCar(null)
                    setFormData({
                        make: "",
                    ...
                    <Card key={car.id} className={`border-0 shadow-sm transition-all hover:shadow-md ${!car.is_active ? 'opacity-60 saturate-50' : ''}`}>
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-start justify-between mb-2">
                                <div>
                                    <h4 className="font-bold text-[#1e2a5e] leading-tight">{car.make} {car.model}</h4>
...
export function KarkeyInquiriesList({
    ...
    return (
        <div className="space-y-4">
            <h3 className="text-xl font-bold text-[#1e2a5e]">Karkey Car Inquiries</h3>
