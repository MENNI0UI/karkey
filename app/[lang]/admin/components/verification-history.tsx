              ...
              filteredAdmins.map((group) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full px-4 py-3 flex items-center gap-3 border-b border-slate-50 transition-colors ${isSelected ? "bg-[#B8071C]/5 border-l-2 border-l-[#B8071C]" : "hover:bg-slate-50"
                      }`}
                  >
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center text-sm font-semibold ${isSelected ? "bg-[#B8071C] text-white" : "bg-slate-100 text-slate-600"
                      }`}>
                      ...
                      {calendarWeeks.flat().map((day) => {
                        ...
                        return (
                          <button
                            ...
                            className={`h-8 w-full rounded-lg text-xs font-medium transition-colors relative ${isSelected
